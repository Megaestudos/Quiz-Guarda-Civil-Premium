    ...
    modulos: [
      {
        ...
        missoes: [
          { id: 'gm_dh_001', nome: 'Fundamentos',            materia: 'Direitos Humanos', subassunto: 'Fundamentos',             tempoMin: 15, xp: 50 },
          { id: 'gm_dh_002', nome: 'Declaração Universal',   materia: 'Direitos Humanos', subassunto: 'Declaração Universal',    tempoMin: 20, xp: 60 },
          { id: 'gm_dh_003', nome: 'Pacto de San José',      materia: 'Direitos Humanos', subassunto: 'Pacto de San José',       tempoMin: 20, xp: 60 },
          { id: 'gm_dh_004', nome: 'Sistemas de Proteção',   materia: 'Direitos Humanos', subassunto: 'Sistemas de Proteção',    tempoMin: 25, xp: 70 },
          { id: 'gm_dh_fin', nome: 'Missão Final',           materia: 'Direitos Humanos', subassunto: '',                        tempoMin: 30, xp: 150, isFinal: true },
        ]
      },
      {
